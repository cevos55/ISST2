...
async function checkAgentTrainingStatus() {
    ...
    try {
        ...
        console.log('Agent training status:', response);
        return response;
    } catch (error) {
...
app.post('/dialogflow', [
    ...
    try {
        ...
        // Vérifiez l'état d'entraînement de l'agent après la mise à jour
        const trainingStatus = await checkAgentTrainingStatus();
